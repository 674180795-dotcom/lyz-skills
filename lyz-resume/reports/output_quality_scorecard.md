...
| --- | ---: | ---: | ---: | --- | --- |
| low-information-intake | 25.0 | 100.0 | 75.0 | with_skill | None |
| layout-only-boundary | 0.0 | 100.0 | 100.0 | with_skill | None |
...
| photo-and-uncertainty-checkpoint | 0.0 | 100.0 | 100.0 | with_skill | None |
